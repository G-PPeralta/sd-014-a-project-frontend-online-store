...
export default class BlankStar extends Component {
  render() {
    const { id, onClick } = this.props;
    return (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-star" viewBox="0 0 16 16" id={ id } onClick={ onClick }>
        <path
          d="M2.866 14.85c-.078.444.36.791.746.593l4.39-2.256 4.389
           ...
           6.745l4.052-.576a.525.525 0 0 0 .393-.288L8 2.223l1.847 3.658a.525.525 0 0 0
           .393.288l4.052.575-2.906 2.77a.565.565 0 0 0-.163.506l.694
